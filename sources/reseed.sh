...
RV=$(mkroot red-velvet-cookies);                    echo "  + Red Velvet Protein Cookies (Oat Base)"
...
RVCRUMBL=$(build_variant "$DIR/red-velvet-crumbl.variant.json" "$CRUMBL");     echo "  + Red Velvet Protein Cookies (Crumbl Base, off Crumbl base)"
...
fb "$RV" --to-make -m "Oat-base branch of the red velvet bake-off - rehabbed for floppiness: less pumpkin, double the oat flour, an egg white, no cornstarch, baked 325F/15-18 min. Bake vs the Crumbl-base version, then promote the winner."
fb "$RVCRUMBL" --to-make -m "Crumbl-base branch of the red velvet bake-off - red velvet on the proven family chassis (cocoa + vinegar tang, cream-cheese frosting). Bake vs the oat-base version, then promote the winner."
...
fb "$TURTLE" --made --rating excellent -m "Made and fully tasted — excellent, came out amazing. ~217 cal / 19 g protein per slice (11.5 cal/g)."
